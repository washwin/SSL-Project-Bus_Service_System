                    ...
                    <div>
                        <br>
                                  ...
                                  <form  action="change.php" method="post">
                                        <label for="username">Username<span style="color:red;">*</span></label><br><br>
                                        <input type="text" id="username" size="22" name="username" value="" style="padding:2px 7px" required><br><br>
                                        <label for="npassword">New Password<span style="color:red;">*</span></label><br><br>
